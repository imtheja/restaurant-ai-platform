...
('11111111-1111-1111-1111-111111111006', 'All-purpose flour', 'Grain', '["gluten"]'),
('11111111-1111-1111-1111-111111111007', 'Baking powder', 'Leavening', '[]'),

-- Chocolate varieties
('11111111-1111-1111-1111-111111111008', 'Milk chocolate chips', 'Chocolate', '["dairy"]'),
('11111111-1111-1111-1111-111111111009', 'Semi-sweet chocolate wafers', 'Chocolate', '["dairy"]'),
('11111111-1111-1111-1111-111111111010', 'White chocolate chips', 'Chocolate', '["dairy"]'),

-- Special ingredients
('11111111-1111-1111-1111-111111111011', 'Biscoff cookie crumbs', 'Cookie', '["gluten"]'),
('11111111-1111-1111-1111-111111111012', 'Biscoff cookie butter', 'Spread', '["gluten"]'),
('11111111-1111-1111-1111-111111111013', 'Belgian cocoa powder', 'Chocolate', '[]'),
('11111111-1111-1111-1111-111111111014', 'Maldon sea salt', 'Seasoning', '[]'),
('11111111-1111-1111-1111-111111111015', 'Vegetable shortening', 'Fat', '[]'),
('11111111-1111-1111-1111-111111111016', 'Almond extract', 'Flavoring', '["tree_nuts"]'),
('11111111-1111-1111-1111-111111111017', 'Salt', 'Seasoning', '[]'),

-- Toppings
('11111111-1111-1111-1111-111111111018', 'Caramel sauce', 'Topping', '["dairy"]'),
...
('11111111-1111-1111-1111-111111111023', 'Fresh toasted coconut', 'Topping', '["tree_nuts"]'),
('11111111-1111-1111-1111-111111111024', 'Pistachio cream', 'Nut Spread', '["tree_nuts"]'),
('11111111-1111-1111-1111-111111111025', 'Kataifi (shredded phyllo)', 'Pastry', '["gluten"]'),

-- Frosting ingredients
('11111111-1111-1111-1111-111111111026', 'Cream cheese', 'Dairy', '["dairy"]'),
('11111111-1111-1111-1111-111111111027', 'Confetti sprinkles', 'Topping', '[]'),

-- Beverage ingredients
('11111111-1111-1111-1111-111111111028', 'Whole milk', 'Dairy', '["dairy"]'),
('11111111-1111-1111-1111-111111111029', 'Chocolate syrup', 'Flavoring', '[]'),
('11111111-1111-1111-1111-111111111030', 'Fresh brewed coffee', 'Beverage', '[]'),
('11111111-1111-1111-1111-111111111031', 'Vanilla ice cream', 'Dairy', '["dairy"]')
ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
...
-- Insert menu item ingredients relationships (sample for key items)
-- Boneless cookie ingredients
INSERT INTO menu_item_ingredients (menu_item_id, ingredient_id, quantity, unit, is_optional, is_primary) VALUES 
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111001', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111002', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111003', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111004', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111005', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111006', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222001', '11111111-1111-1111-1111-111111111007', '1', 'portion', false, false)
ON CONFLICT (menu_item_id, ingredient_id) DO NOTHING;

-- OG cookie ingredients
INSERT INTO menu_item_ingredients (menu_item_id, ingredient_id, quantity, unit, is_optional, is_primary) VALUES 
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111008', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111001', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111002', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111003', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111004', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111005', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111006', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222002', '11111111-1111-1111-1111-111111111007', '1', 'portion', false, false)
ON CONFLICT (menu_item_id, ingredient_id) DO NOTHING;

-- Biscoff cookie ingredients
INSERT INTO menu_item_ingredients (menu_item_id, ingredient_id, quantity, unit, is_optional, is_primary) VALUES 
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111001', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111002', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111003', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111010', '1', 'portion', false, true),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111011', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111012', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111004', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111005', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111006', '1', 'portion', false, false),
('22222222-2222-2222-2222-222222222003', '11111111-1111-1111-1111-111111111007', '1', 'portion', false, false)
ON CONFLICT (menu_item_id, ingredient_id) DO NOTHING;

-- Fresh Milk beverage
INSERT INTO menu_item_ingredients (menu_item_id, ingredient_id, quantity, unit, is_optional, is_primary) VALUES 
('22222222-2222-2222-2222-222222222012', '11111111-1111-1111-1111-111111111028', '1', 'serving', false, true)
ON CONFLICT (menu_item_id, ingredient_id) DO NOTHING;
